...
it('initializes and checks', () => {
  execSync('python datasets/pipeline/build.py --version 20250101.1 --sources datasets/raw/sample_global.txt --out datasets', { stdio: 'inherit' });
  initialize({ tier: 'tiny', version: '20250101.1' });
